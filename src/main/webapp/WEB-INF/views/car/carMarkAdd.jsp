    ...
    <div class="dashboard-content border-dashed p-3 m-4 view-height">
        <div class="mt-4 ml-4 mr-4">
            <div class="row border-bottom border-3">
                <div class="col"><h3 class="color-header text-uppercase">Dodawanie marki samochodu</h3></div>
            ...
            <form:form method="post" modelAttribute="carMark">
                ...
                <table class="table borderless">
                    <tbody>
                    <tr class="d-flex">
                        <th scope="row" class="col-2">Nazwa Marki</th>
                        <td class="col-7">
                    ...
                    <tr class="d-flex">
                        <div class="col d-flex justify-content-end mb-2">
                            ...
                            <td class="col-7">
                                <input class="btn-color" type="submit" value="Dodaj marke"><br>
                        </div>
                        </td>
                    </tr>
